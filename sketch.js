...
function preload(){
  ...
  backgroundImg = loadImage("GPMXR9.jpg")
...
function setup() {
  ...
  ground = createSprite(200,480,300,20);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown(UP_ARROW) && trex.y >= 459) {
      trex.velocityY = -12;
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(180,420));
